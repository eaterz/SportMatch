...
export default function Step5({ profile, currentStep, totalSteps }: Props) {
    ...
    return (
        <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
            <Head title="Profila iestatīšana - 5. solis" />
            ...
            <div className="w-full max-w-md">
                ...
                <div className="bg-white rounded-lg shadow-lg p-6">
                    ...
                    <Form method="post" action={route('profile.setup.step5.store')}>
                        {({ processing, errors }) => (
                            <div className="space-y-4">
                                ...
                                <div className="flex gap-3 pt-2">
                                    <a
                                        href={route('profile.setup.step4')}
